-- Front Photobooth - Local Schema (SQLite)
-- Target: local development database (storage/local.sqlite)
-- Date: 2026-03-10
...
-- Minimal defaults (full CMS keys auto-seed by app)
...
-- Notes:
-- 1) All CMS menu/section keys are auto-seeded by config.php when the app runs.
