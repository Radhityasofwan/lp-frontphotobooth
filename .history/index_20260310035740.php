...
<section class="hero-section bg-orange-gradient">
  ...
  <div class="shape-blob bg-white float-anim"
    style="width: 400px; height: 400px; top: -100px; left: -100px; opacity: 0.1;"></div> <!-- Inline style for position is fine -->

  <div class="container hero-content">
    <div class="row align-items-center">

      <div class="col-lg-7 text-center text-lg-start mb-5 mb-lg-0 js-scroll">
        <span class="badge bg-white text-dark mb-4 px-4 py-2 rounded-pill letter-spacing-1 fw-bold text-uppercase shadow-sm">
      ...
      <div class="col-lg-5 position-relative d-none d-lg-block js-scroll">
        <i class="ph-fill ph-shooting-star text-white position-absolute float-anim" style="font-size: 3rem; top: -20px; right: 40px; opacity: 0.8; transform: rotate(15deg); z-index: 10;"></i>
        <i class="ph-fill ph-camera text-white position-absolute float-anim-delay" style="font-size: 4rem; bottom: -20px; left: 10px; opacity: 0.2; transform: rotate(-15deg);"></i>
...
<section class="section-padding-bottom-0 pt-5 position-relative">
  <div class="container text-center">
    ...
    <div class="shape-blob" style="width:300px; height:300px; background:var(--fp-primary); right:-100px; top:200px; opacity:0.05;"></div>
    ...
    <div class="mb-5 pb-5 js-scroll">
      ...
      <div class="d-inline-block p-4 bg-alt rounded-4 tilt-3 mb-4 shadow-sm border position-relative">
        <i class="ph-fill ph-quotes text-orange position-absolute" style="font-size: 2rem; top:-15px; left:-15px; opacity:0.8;"></i>
...
<section class="section-padding position-relative">
  <div class="container">
    ...
    <div class="row align-items-center g-5">
      ...
      <div class="col-lg-6 js-scroll ps-lg-5 position-relative" style="z-index: 10;">
        ...
        <div class="d-flex align-items-center gap-3">
          <div class="icon-circle m-0 bg-white shadow-sm" style="width:50px; height:50px;"><i class="ph-bold ph-lightning text-orange fs-4"></i></div>
...
<section id="paket" class="section-padding pb-5" style="padding-top: 0;">
  <div class="container">
    ...
    <div class="row g-4 justify-content-center align-items-stretch position-relative">
      ...
      <div class="position-absolute top-50 start-50 translate-middle bg-alt rounded-4 w-75 h-75 d-none d-lg-block" style="z-index: 0;"></div>

      <div class="col-lg-4 js-scroll" style="z-index: 10;">
      ...
      <div class="col-lg-4 js-scroll" style="z-index: 10;">
        <div class="card-playful tilt-3 border-0 shadow-sm px-4">
          <div class="tape"></div>
          <div class="text-center mb-4">
            <div class="icon-circle shadow-sm" style="width:60px; height:60px;"><i class="ph-fill ph-buildings fs-3"></i></div>
...
<section class="section-padding">
  <div class="container text-center">
    <h2 class="display-6 mb-3 js-scroll"><?= h(get_setting('home_clients_title', 'Telah Dipercaya Oleh')) ?></h2>
    <p class="text-muted-custom mb-5 mx-auto js-scroll" style="max-width: 500px;">
      <?= h(get_setting('home_clients_desc', 'Kami bangga telah menjadi bagian dari momen spesial berbagai brand ternama dan acara personal yang tak terlupakan.')) ?>
    </p>
...
<section class="section-padding position-relative" style="padding-top: 0;">
  <div class="container position-relative" style="z-index: 10;">
    ...
    <div class="js-scroll text-center mt-5 pt-4">
      <div class="d-inline-flex align-items-center gap-2 px-3 py-1 bg-dark text-white rounded-pill fw-bold small mb-3 shadow-sm">
        <i class="ph-fill ph-warning-circle text-warning fs-5"></i>
        <?= h(get_setting('home_scarcity_badge', 'PENTING BANGET')) ?>
      </div>
      <h3 class="display-6 mx-auto mb-3 text-dark" style="max-width: 700px;">
...
<section id="kontak" class="section-padding bg-orange-gradient text-center position-relative overflow-hidden" style="padding: 8rem 0;">
  ...
  <div class="container js-scroll position-relative mt-4" style="z-index: 10;">
    ...
    <div class="d-flex justify-content-center flex-wrap gap-4">
      <a href="<?= htmlspecialchars(get_setting('home_close_cta1_link', 'https://frontphotobooth.com')) ?>" data-track="click_cta_booking" class="btn btn-playful bg-white text-dark border-0 px-5 py-3 fs-5 fw-bold shadow-lg" style="box-shadow: 0 10px 30px rgba(0,0,0,0.15) !important;">
