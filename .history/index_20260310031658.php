...
<!-- Diagonal Transition -->
<div class="position-relative" style="height: 100px; background: transparent; clip-path: polygon(0 0, 100% 100%, 100% 0);">
  <div style="background: transparent; width: 100%; height: 100%;"></div>
</div>

<!-- 6. PACKAGE -->
<section id="paket" class="section-padding pb-5">
  <div class="container">
...
<section id="galeri" class="section-padding overflow-hidden position-relative border-top border-bottom border-light">
  <!-- Top Curve Divider -->
